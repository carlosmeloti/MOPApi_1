...
import br.embrapa.model.pk.ModNivel1_PK_;
import br.embrapa.model.pk.ModNivel2_PK_;
import br.embrapa.model.pk.ModNivel3_PK_;
import br.embrapa.model.pk.ModNivel4_PK_;
...
public class ModNivel4RepositoryImpl {
	...
	private Predicate[] criarRestricoes(ModNivel4Filter modNivel4Filter, CriteriaBuilder builder,
		...
		if (modNivel4Filter.getCdNivel3() != null) {
			predicates.add(
			builder.equal(root.get(ModNivel4_.pkNivel4).get(ModNivel4_PK_.modNivel3).get(ModNivel3_.pkNivel3).get(ModNivel3_PK_.cdNivel3), modNivel4Filter.getCdNivel3()));
		}
